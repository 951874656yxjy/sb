...
<div class="container">
 ...
 <div class="container">
   ...
   <div class="col-md-10">
    <div class="container">
       <c:forEach items="${requestScope.Tshirt_list }" var="t">
    <div class="col-sm-3 col-md-3 col-lg-3 col-xs-6">
      <div class="thumbnail"> <img src="images/${t.image }" alt="Thumbnail Image 1" class="img-responsive">
        <div class="caption">
          <div class="col-md-7" > 
            <p>${t.descripts}</p>
          </div>
          <div class="col-md-5"></div>
              <p>${t.price }</p>
              <p><a href="product.action?id=${t.id }&pid=${t.id}" class="btn btn-warning" role="button"> 立即购买</a></p>
        </div>
       </div>
     </div> 
   </c:forEach>
