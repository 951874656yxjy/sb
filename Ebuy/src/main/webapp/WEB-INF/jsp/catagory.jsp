...
<html lang="en">
    ...
    <table class="myown" border="1">
     	<thead>
            ...
            <c:forEach items="${requestScope.product_list }" var="n">
            <form action="updatecatagory"  method="post">
             <tr >
             	<td style="vertical-align: middle;">${n.id } </td>
             	<td style="vertical-align: middle;"><img src="images/${n.image}" width="70" /></td>
             	<td style="vertical-align: middle;"><input type="text" id="name" name="name" value="${n.name}"/></td>
             	<td style="vertical-align: middle;"><input type="text" id="typeid" name="typeid" value="${n.typeid}"/></td>
             	<td style="vertical-align: middle;"><input type="text" id="price" name="price" value="${n.price}"/></td>
